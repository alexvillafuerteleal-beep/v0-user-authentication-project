...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!isSupabaseClientConfigured()) {
      setError("El registro quedará disponible cuando se complete la configuración pendiente.")
      return
    }
  ...
  const handleGoogleSignUp = async () => {
    ...
    if (!isSupabaseClientConfigured()) {
      setError("El registro con Google quedará disponible cuando se complete la configuración pendiente.")
      return
    }
        ...
        <CardHeader className="text-center">
          <Link href="/" className="flex items-center justify-center gap-2 mb-4 hover:opacity-80 transition-all duration-300">
            <svg viewBox="0 0 64 64" className="w-12 h-12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <radialGradient id="sphereGradient4" cx="35%" cy="35%">
                  <stop offset="0%" stopColor="#00D9FF" />
                  <stop offset="70%" stopColor="#00A8FF" />
                  <stop offset="100%" stopColor="#0066FF" />
                </radialGradient>
                <filter id="neonGlow4" x="-50%" y="-50%" width="200%" height="200%">
                ...
                <filter id="strongGlow4" x="-100%" y="-100%" width="300%" height="300%">
              ...
              <circle cx="32" cy="32" r="28" fill="url(#sphereGradient4)" opacity="0.12" />
              <circle cx="32" cy="32" r="26" fill="none" stroke="url(#sphereGradient4)" strokeWidth="1" opacity="0.25" />
              <circle cx="32" cy="32" r="24" fill="none" stroke="#00FF88" strokeWidth="0.8" opacity="0.15" strokeDasharray="3,2" />
              <text x="32" y="38" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#00D9FF" opacity="0.9" filter="url(#strongGlow4)" fontFamily="system-ui, -apple-system, sans-serif">Pg</text>
              <circle cx="32" cy="18" r="1.8" fill="#00FF88" filter="url(#neonGlow4)" />
              <circle cx="42" cy="22" r="1.6" fill="#00D9FF" filter="url(#neonGlow4)" />
              <circle cx="48" cy="30" r="1.5" fill="#00FF88" filter="url(#neonGlow4)" />
              <circle cx="16" cy="30" r="1.5" fill="#00FF88" filter="url(#neonGlow4)" />
              <circle cx="22" cy="46" r="1.6" fill="#00D9FF" filter="url(#neonGlow4)" />
              <circle cx="42" cy="46" r="1.6" fill="#00D9FF" filter="url(#neonGlow4)" />
